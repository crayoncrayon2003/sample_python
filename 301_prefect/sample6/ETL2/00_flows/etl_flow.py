...
# --- ETL2のメインフロー ---
@flow(name="ETL2 - CSV to NGSI-v2 (pluggy-based)", log_prints=True)
def etl2_main_flow():
    """
    Defines and runs the ETL2 pipeline using the pluggy-based framework.
    """
