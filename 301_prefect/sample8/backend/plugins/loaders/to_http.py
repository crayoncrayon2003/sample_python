        ...
        return {
            ...
            "properties": {
                "input_path": {
                    ...
                    "description": "The JSON Lines file whose lines will be sent as requests."
                },
                "url": {
                    "type": "string",
                    "title": "Target URL",
                    "description": "The HTTP endpoint to send the POST/PUT requests to."
                },
                "method": {
                    "type": "string",
                    "title": "HTTP Method",
                ...
                "concurrency": {
                    "type": "integer",
                    "title": "Concurrency",
                    "description": "The number of concurrent requests to send.",
                    "default": 10
                }
            },
