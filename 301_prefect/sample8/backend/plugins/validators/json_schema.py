...
class JsonSchemaValidator:
        ...
        return {
            ...
            "properties": {
                "input_path": {
                    ...
                    "description": "The Parquet or JSONL file to validate."
                },
                "output_path": {
                    "type": "string",
                ...
                "schema_path": {
                    ...
                    "description": "The path to the .json file defining the schema."
                },
                "target_column": {
                    "type": "string",
                    "title": "Target Column",
                    "description": "The column containing the JSON objects/strings to validate."
                }
            },
    ...
    def execute_plugin(
        ...
        # Assume Parquet, but can be adapted for other tabular formats
