# backend/plugins/transformers/gtfs_processor.py
    ...
    def get_parameters_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                "input_path": {
                    "type": "string",
                    "title": "Input GTFS Directory",
                    "description": "Path to the directory containing extracted GTFS .txt files."
                },
                "output_path": {
                    "type": "string",
                    "title": "Output Parquet Directory",
                    "description": "Directory to save the converted GTFS tables as Parquet files."
                }
            },
