# backend/plugins/transformers/to_ngsi.py
        ...
        return {
            ...
            "properties": {
                "input_path": {
                    ...
                    "description": "The Parquet file with data structured for NGSI entities."
                },
                "output_path": {
                    "type": "string",
                    "title": "Output NGSI JSONL Path",
                    "description": "Path to save the generated NGSI entities as a JSON Lines file."
                },
                "template_path": {
                    "type": "string",
                    "title": "NGSI Template Path",
                    "description": "The path to the Jinja2 template for the NGSI entity."
                },
                "entity_type": {
                    "type": "string",
                    "title": "Entity Type",
                    "description": "The 'type' of the NGSI entities to be created (e.g., 'Device')."
                },
                "id_column": {
                    "type": "string",
                    "title": "ID Column (Optional)",
                    "description": "The column in the input file to use for the entity ID. If omitted, a UUID is generated."
                },
                "id_prefix": {
                    "type": "string",
                    "title": "ID Prefix (Optional)",
                    "description": "A prefix to add to each entity ID (e.g., 'urn:ngsi-ld:Device:').",
                    "default": ""
                }
            },
            "required": ["input_path", "output_path", "template_path", "entity_type"]
        }
